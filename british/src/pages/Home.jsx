    ...
    <div className="homepage_home">
      ...
      <div className="hero-banner_home">
        <div className="hero-content_home">
          <h1 className="headline_home">
            Unlock Your Potential: <br />
            Master British English with Certify.brit!
          </h1>
          <h2 className="subheadline_home">
            Streamline your journey to proficiency with our powerful enquiry and
      ...
      <div className="key-features_home">
        <div className="feature-card_home">
          <h3 className="feature-heading_home">
            <h3>
              <SendIcon />
            </h3>
            Easy Enquiries
          </h3>
          <p className="feature-description_home">
            Submit & Track Enquiries with Ease.
          </p>
        </div>
        <div className="feature-card_home">
          <h3>
      ...
      <div className="success-stories_home">{/* Testimonials */}</div>
