  ...
  return (
    <div className="enquiry-page_enquiry">
      ...
      <div className="hero-banner_enquiry">
        <h1 className="headline_enquiry">
          Have Questions? We are Here to Help! <br />
          Contact Certify.brit for All Your Enquiries.
        </h1>
        <h2 className="subheadline_enquiry">
          Get personalized assistance with course details, payment options, and
      ...
      <div className="enquiry-form_enquiry">
        <form onSubmit={handleSubmit}>
          <div className="input-group_enquiry">
            <label htmlFor="name" className="label_enquiry">
              Name:
            </label>
            <input type="text" id="name" className="input_enquiry" required />
          </div>
          <div className="input-group_enquiry">
            <label htmlFor="email" className="label_enquiry">
              Email:
            </label>
            <input type="email" id="email" className="input_enquiry" required />
          </div>
          <div className="input-group_enquiry">
            <label htmlFor="category" className="label_enquiry">
              Enquiry Category:
            </label>
          ...
          <div className="input-group_enquiry">
            <label htmlFor="message" className="label_enquiry">
              Message:
            </label>
            <textarea
              id="message"
              className="textarea_enquiry"
              rows="4"
              required
            ></textarea>
          </div>
          <button type="submit" className="submit-btn_enquiry">
            Submit
          </button>
        </form>
      </div>
